                    ...
                    <td data-label="操作">${
                        (myId && u.id === myId)
                            ...
                            : `<button class="btn btn-outline" style="padding:2px 6px;margin-right:4px;" onclick="openUserModal('edit', ${u.id})" title="編輯">✏️</button>
                               <button class="btn btn-outline" style="padding:2px 6px;margin-right:4px;font-size:12px;" onclick="toggleUserDisable(${u.id})" title="${u.isDisabled === true ? '啟用此帳號' : '停用此帳號'}">${u.isDisabled === true ? '啟用' : '停用'}</button>
